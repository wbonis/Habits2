...
function getConnection() {
	...
	global $db_Habits2_db_Url, $db_Habits2_db_User, $db_Habits2_db_Pass, $db_Habits2_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Habits2_db_Url.";dbname=".$db_Habits2_db_DbName, $db_Habits2_db_User, $db_Habits2_db_Pass);
